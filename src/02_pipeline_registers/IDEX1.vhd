...
architecture rtl of IDEX1 is
    ...
    signal rsrc1_addr_str   : std_logic_vector(2 downto 0)  := (others => '0');
    signal rsrc2_addr_str   : std_logic_vector(2 downto 0)  := (others => '0');
    signal input_port_str   : std_logic_vector(31 downto 0) := (others => '0');

    -- Control signals
    signal alu_src_str      : std_logic := '0';
...
begin
    ...
    begin
        if rising_edge(clk) then
            if flush = '1' then
                ...
                rsrc1_addr_str   <= (others => '0');
                rsrc2_addr_str   <= (others => '0');
                ...
                rsrc1_addr_str   <= rsrc1_addr;
                rsrc2_addr_str   <= rsrc2_addr;
    ...
    rsrc1_addr_out   <= rsrc1_addr_str;
    rsrc2_addr_out   <= rsrc2_addr_str;
    input_port_out   <= input_port_str;

    alu_src_out      <= alu_src_str;
